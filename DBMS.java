...
class DBMS
{
    ...
    public void SelectStarFromWhereCityAndMarks(String str, int Mark)
    {
        System.out.println("Data from the student table where city is : "+str+" and Marks is > "+Mark);
        ...
        while(temp != null)
        {
            if(str.equals(temp.City) && (temp.Marks >= Mark))
            {
                System.out.println(temp.Rno+"\t"+temp.Name+"\t"+temp.City+"\t"+temp.Marks);
            }
            temp = temp.next;
...
class Pra431
{
    public static void main(String Arg[])
    {
        ...
        obj.SelectStarFromWhereCityAndMarks("Pune", 90);
...
3 : select *  from student where City = '_____'and Marks > ___;
